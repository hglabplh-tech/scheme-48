...
(define open-file-input-port
  (opt-lambda (filename ((file-options *default-file-options*)))
    (external-r6rs-open-file-input-port filename os-enc )))
...
(define open-file-output-port
  (opt-lambda (filename ((file-options *default-file-options*)))
    (external-r6rs-open-file-output-port filename os-enc)))
...
(define open-file-input-output-port
  (opt-lambda (filename ((file-options *default-file-options*)))
    (external-r6rs-open-file-input-output-port filename os-enc)))
